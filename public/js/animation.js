...
function degatAnimation(degat,critique){
    ...
    container_degat.style.display = "block";
    container_degat.innerHTML = degat;
    if(critique == "oui"){
        container_degat.style.color = "yellow";
    }
    $("#container_degat_"+ennemicharacters[defenseur].ennemi+defenseur).fadeIn(200).animate({"top":"-=100px"},2500).fadeOut(200).animate({"top":"+=100px"},100);
}
